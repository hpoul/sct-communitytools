...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkListPostExtension'
        db.create_table('sphlinklist_linklistpostextension', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sphboard.Post'], unique=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('sphlinklist', ['LinkListPostExtension'])

    def backwards(self, orm):
        # Deleting model 'LinkListPostExtension'
        db.delete_table('sphlinklist_linklistpostextension')
    ...
    models = {
        ...
        'sphlinklist.linklistpostextension': {
            'Meta': {'object_name': 'LinkListPostExtension'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
