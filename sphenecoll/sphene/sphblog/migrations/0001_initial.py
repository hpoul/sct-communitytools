...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlogPostExtension'
        db.create_table('sphblog_blogpostextension', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sphboard.Post'], unique=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
            ('slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=250, db_index=True)),
        ))
        db.send_create_signal('sphblog', ['BlogPostExtension'])

        # Adding model 'BlogCategoryConfig'
        db.create_table('sphblog_blogcategoryconfig', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sphboard.Category'], unique=True)),
            ('enable_googleblogping', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('sphblog', ['BlogCategoryConfig'])

    def backwards(self, orm):
        # Deleting model 'BlogPostExtension'
        db.delete_table('sphblog_blogpostextension')

        # Deleting model 'BlogCategoryConfig'
        db.delete_table('sphblog_blogcategoryconfig')
    ...
    models = {
        ...
        'sphblog.blogcategoryconfig': {
            'Meta': {'object_name': 'BlogCategoryConfig'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sphboard.Category']", 'unique': 'True'}),
            'enable_googleblogping': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'sphblog.blogpostextension': {
            'Meta': {'object_name': 'BlogPostExtension'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sphboard.Post']", 'unique': 'True'}),
